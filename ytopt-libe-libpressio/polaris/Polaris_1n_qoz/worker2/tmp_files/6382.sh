{
  "/pressio/roibin/background/pressio/qoz:qoz:maxstep":  {"type": 13, "value": 8},
  "/pressio/roibin/background/pressio:pressio:compressor": "qoz",
  ...
  "roibin:nthreads": {"type":0, "value": 4},
  "binning:shape": [2,2,1],
